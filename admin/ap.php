                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
								...
								<input type="button" value="Reservation Request" class="myButton" onclick="window.location='index.php'">
								<br><br>
								...
								<th><b><center>Full Address</th>
								<th><b><center>Email</th>
								<th><b><center>Arrive Date</th>
								<th><b><center>Departure Date</th>
...
$result = mysql_query("SELECT * FROM reserve WHERE status = 'Approved' ORDER BY name ASC");
while($row = mysql_fetch_array($result))
{	
		echo '<tr>';
		echo '	<td>'.$row['name'].'</td>';
		echo '	<td>'.$row['contact'].'</td>';
		echo '	<td>'.$row['number'].' '.$row['street'].' '.$row['city'].'</td>';
		echo '	<td>'.$row['email'].'</td>';
		echo '	<td>'.$row['arrive'].'</td>';
		echo '	<td>'.$row['depart'].'</td>';

		echo '	<td><center><a href="view.php?id='.$row['id'].'" rel="facebox" >View Reservation Request</a> | <a href="approve.php?id='.$row["id"].'">Approve Reservation</a> | <a href="decline.php?id='.$row["id"].'">Decline Reservation</a></td>';		
		echo '</tr>';
